...
- Deuda tecnica: renombrar tamano_bytes (con enie en el original) -> tamano_bytes
  en skills/lector_correos/lector_correos.py (linea 86, definicion del dataclass)
  y propagar a mcp_servers/mcp_lector_correos/server.py y src/finanzas_familia.py
  (CITA-009 -- 3 archivos afectados, ver grep de sesion 2026-06-29)

## Warnings CITA de esta sesion
CITA-009: Caracteres no-ASCII detectados en: docs/HANDOFF_20260629.md
